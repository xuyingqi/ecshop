...
<div class="block" style="background: url(themes/default/images/img_index/bg.png) no-repeat center center;padding-top: 100px;">
    <div class="container">
        <div class="row">
            <div class=" col-md-2">
            ...
            <div class=" col-md-10">
                <div class="userCenterBox boxCenterList clearfix" style="height: 664px;font-family: 'ywsf';font-size: 18px; border: 1px solid #ccc;">
                    
                    <?php if ($this->_var['action'] == 'default'): ?>
                    <p class="f5">
                        <b class="f4"><?php echo $this->_var['info']['username']; ?></b>
                        <?php echo $this->_var['lang']['welcome_return']; ?>！
                    </p>
                    ...
                    <div class="f_l" style="width:350px;">
                        <div class="title"><span><?php echo $this->_var['lang']['your_account']; ?></span></div>
                        <div class="blank"></div>
                    ...
                    <div class="f_r" style="width:350px;">
                        <div class="title"><span><?php echo $this->_var['lang']['your_notice']; ?></span></div>
                        <div class="blank"></div>
...
?>
                    ...
                    <div class="title"><span><?php echo $this->_var['lang']['label_message']; ?></span></div>
                    <div class="blank"></div>
...
?>
                    <div class="f_l">
                        <b><?php echo $this->_var['message']['msg_type']; ?>:</b>&nbsp;&nbsp;
                        <font class="f4"><?php echo $this->_var['message']['msg_title']; ?></font>
                        (<?php echo $this->_var['message']['msg_time']; ?>)
                    </div>
                    ...
                    <div class="title"><span><?php echo $this->_var['lang']['label_comment']; ?></span></div>
                    <div class="blank"></div>
...
?>
                    ...
                    <div class="title"><span><?php echo $this->_var['lang']['label_tag']; ?></span></div>
                    <div class="blank"></div>
...
?>
                    ...
                    <div class="title"><span><?php echo $this->_var['lang']['label_collection']; ?></span></div>
                    <div class="blank"></div>
...
?>
                ...
                <?php echo $this->fetch('library/pages.lbi'); ?>
                    <div class="blank5"></div>
                    <div class="title"><span><?php echo $this->_var['lang']['label_affiliate']; ?></span></div>
                    <div class="blank"></div>
                    <form name="theForm" method="post" action="">
                        <table width="100%" border="0" cellpadding="5" cellspacing="1">
                            <tr>
                                <td align="right"><?php echo $this->_var['lang']['label_need_image']; ?></td>
                                <td>
                            ...
                            <tr>
                                <td colspan="2" align="center" bgcolor="#ffffff">
                                    <input type="button" name="gen_code" value="<?php echo $this->_var['lang']['generate']; ?>" onclick="genCode()" class="bnt_blue_1" />
                                </td>
                            </tr>
                            <tr class="blank"></tr>
                            <tr>
                    ...
                    <div class="title"><span><?php echo $this->_var['lang']['label_booking']; ?></span></div>
                    <div class="blank"></div>
                    <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                        <tr align="center">
                            <td width="20%"><?php echo $this->_var['lang']['booking_goods_name']; ?></td>
                            <td width="10%"><?php echo $this->_var['lang']['booking_amount']; ?></td>
                            <td width="20%"><?php echo $this->_var['lang']['booking_time']; ?></td>
                            <td width="35%"><?php echo $this->_var['lang']['process_desc']; ?></td>
                            <td width="15%"><?php echo $this->_var['lang']['handle']; ?></td>
                        </tr>
...
?>
                    ...
                    <div class="title"><span><?php echo $this->_var['lang']['add']; ?><?php echo $this->_var['lang']['label_booking']; ?></span></div>
                    <div class="blank"></div>
                    ...
                    <div class="title"><span><?php echo $this->_var['lang']['affiliate_detail']; ?></span></div>
                    <div class="blank"></div>
                    <?php echo $this->_var['affiliate_intro']; ?>
                    <?php if ($this->_var['affiliate']['config']['separate_by'] == 0): ?>
                    
                    <div class="blank"></div>
                    <div class="title"><span><a name="myrecommend"><?php echo $this->_var['lang']['affiliate_member']; ?></a></span></div>
                    <div class="blank"></div>
                    <table width="100%" border="0" cellpadding="5" cellspacing="1">
                        <tr align="center">
...
?>
                    ...
                    <div class="blank"></div>
                    <div class="title"><span>分成规则</span></div>
                    <div class="blank"></div>
                    <table width="100%" border="0" cellpadding="5" cellspacing="1">
                        <tr align="center">
                            <td><?php echo $this->_var['lang']['order_number']; ?></td>
                            <td><?php echo $this->_var['lang']['affiliate_money']; ?></td>
                            <td><?php echo $this->_var['lang']['affiliate_point']; ?></td>
                            <td><?php echo $this->_var['lang']['affiliate_mode']; ?></td>
                            <td><?php echo $this->_var['lang']['affiliate_status']; ?></td>
                        </tr>
...
?>
                        <tr align="center">
                            ...
                            <td><?php echo $this->_var['val']['money']; ?></td>
                            <td><?php echo $this->_var['val']['point']; ?></td>
                            <td><?php if ($this->_var['val']['separate_type'] == 1 || $this->_var['val']['separate_type'] === 0): ?><?php echo $this->_var['lang']['affiliate_type'][$this->_var['val']['separate_type']]; ?><?php else: ?><?php echo $this->_var['lang']['affiliate_type'][$this->_var['affiliate_type']]; ?><?php endif; ?></td>
                            <td><?php echo $this->_var['lang']['affiliate_stats'][$this->_var['val']['is_separate']]; ?></td>
                        </tr>
                        <?php endforeach; else: ?>
                        <tr><td colspan="5" align="center"><?php echo $this->_var['lang']['no_records']; ?></td>
                        </tr>
                    ...
                    <div class="blank"></div>
                    <div class="title"><span><?php echo $this->_var['lang']['affiliate_code']; ?></span></div>
                    <div class="blank"></div>
                    <table width="100%" border="0" cellpadding="5" cellspacing="1">
                        <tr>
                            <td width="30%"><a href="<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>" target="_blank" class="f6"><?php echo $this->_var['shopname']; ?></a></td>
                            <td><input size="40" onclick="this.select();" type="text" value="&lt;a href=&quot;<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>&quot; target=&quot;_blank&quot;&gt;<?php echo $this->_var['shopname']; ?>&lt;/a&gt;" style="border:1px solid #ccc;" /> <?php echo $this->_var['lang']['recommend_webcode']; ?></td>
                        </tr>
                        <tr>
                            <td><a href="<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>" target="_blank" title="<?php echo $this->_var['shopname']; ?>"  class="f6"><img src="<?php echo $this->_var['shopurl']; ?><?php echo $this->_var['logosrc']; ?>" /></a></td>
                            <td><input size="40" onclick="this.select();" type="text" value="&lt;a href=&quot;<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>&quot; target=&quot;_blank&quot; title=&quot;<?php echo $this->_var['shopname']; ?>&quot;&gt;&lt;img src=&quot;<?php echo $this->_var['shopurl']; ?><?php echo $this->_var['logosrc']; ?>&quot; /&gt;&lt;/a&gt;" style="border:1px solid #ccc;" /> <?php echo $this->_var['lang']['recommend_webcode']; ?></td>
                        </tr>
                        <tr>
                            <td><a href="<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>" target="_blank" class="f6"><?php echo $this->_var['shopname']; ?></a></td>
                            <td><input size="40" onclick="this.select();" type="text" value="[url=<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>]<?php echo $this->_var['shopname']; ?>[/url]" style="border:1px solid #ccc;" /> <?php echo $this->_var['lang']['recommend_bbscode']; ?></td>
                        </tr>
                        <tr>
                            <td><a href="<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>" target="_blank" title="<?php echo $this->_var['shopname']; ?>" class="f6"><img src="<?php echo $this->_var['shopurl']; ?><?php echo $this->_var['logosrc']; ?>" /></a></td>
                            <td><input size="40" onclick="this.select();" type="text" value="[url=<?php echo $this->_var['shopurl']; ?>?u=<?php echo $this->_var['userid']; ?>][img]<?php echo $this->_var['shopurl']; ?><?php echo $this->_var['logosrc']; ?>[/img][/url]" style="border:1px solid #ccc;" /> <?php echo $this->_var['lang']['recommend_bbscode']; ?></td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" border="0" cellpadding="5" cellspacing="1">
                        <tr align="center">
                            <td><?php echo $this->_var['lang']['affiliate_view']; ?></td>
                            <td><?php echo $this->_var['lang']['affiliate_code']; ?></td>
                        </tr>
...
?>
                        <tr align="center">
                            <td class="types"><script src="<?php echo $this->_var['shopurl']; ?>affiliate.php?charset=<?php echo $this->_var['ecs_charset']; ?>&gid=<?php echo $this->_var['goodsid']; ?>&u=<?php echo $this->_var['userid']; ?>&type=<?php echo $this->_var['val']; ?>"></script></td>
                            <td>javascript <?php echo $this->_var['lang']['affiliate_codetype']; ?><br>
